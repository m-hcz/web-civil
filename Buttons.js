...
$("#btn1").click(() => {
  ...
  // append new chapter
  $("#kap").append(
    `<img src='/web-civil/images/k1/k1i1.jpg' alt=''/><p> Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto</p>${copy}`
  );
});
...
const kap2Img = `<img class='w40' src='/web-civil/images/k1/k1i2.jpg' alt=''/>`;
